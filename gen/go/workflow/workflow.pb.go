...
const file_proto_workflow_proto_rawDesc = "" +
	"\n" +
	"\x14proto/workflow.proto\x12\bworkflow\"\x1c\n" +
	"\n" +
	"TaskDetail\x12\x0e\n" +
	...
	"\vTaskService\x12<\n" +
	"\n" +
	"AssignTask\x12\x14.workflow.TaskDetail\x1a\x14.workflow.TaskStatus(\x010\x01B\fZ\n" +
	"./workflowb\x06proto3"
...
var file_proto_workflow_proto_goTypes = []any{
	(*TaskDetail)(nil), // 0: workflow.TaskDetail
	(*TaskStatus)(nil), // 1: workflow.TaskStatus
}
var file_proto_workflow_proto_depIdxs = []int32{
	0, // 0: workflow.TaskService.AssignTask:input_type -> workflow.TaskDetail
	1, // 1: workflow.TaskService.AssignTask:output_type -> workflow.TaskStatus
